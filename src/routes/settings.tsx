      ...
      <Group title="فروشگاه و نمایش" subtitle="نام فروشگاه و واحد مبالغ" icon={Settings} defaultOpen>
        ...
        <div className="rounded-xl border border-border bg-background p-3">
          ...
          <p className="mt-1.5 text-xs leading-5 text-muted-foreground">
            ...
            می‌شوند. وقتی «ریال» را انتخاب کنید، <strong>ورود قیمت محصول هم به ریال</strong> است
            تا با نمایش یکی باشد. ذخیره داخلی همچنان به تومان است (هر ۱ تومان = ۱۰ ریال).
          </p>
        </div>
      </Group>
      ...
      <Group title="فاکتور" subtitle="اندازه فونت و چیدمان فاکتور" icon={FileText}>
        ...
        <div>
          ...
          <p className="mt-1.5 text-[11px] leading-5 text-muted-foreground">
            هنگام پرینت هم می‌توانید کاغذ را عوض کنید. پیش‌نمایش داخل برنامه همیشه
