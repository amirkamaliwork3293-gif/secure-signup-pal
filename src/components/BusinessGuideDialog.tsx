...
const GUIDES: Guide[] = [
  {
    ...
    intro:
      "بوتیک و فروشگاه پوشاک با تنوع سایز و رنگ سریع از کنترل خارج می‌شود. کمالی حسابداری کاری می‌کند که هر مدل، سایز و رنگ به‌صورت جدا کنترل شود و صندوق‌داری در چند ثانیه با اسکن موبایل انجام گیرد.",
    problems: [
  ...
  },
  {
    ...
    intro:
      "کافه و رستوران به منوی همیشه‌به‌روز و صورتحساب سریع نیاز دارد. کمالی حسابداری با منوی دیجیتال QR و فاکتور آنی، تجربه‌ای حرفه‌ای برای مشتری و کنترل کامل برای شما می‌سازد.",
    problems: [
  ...
  },
  {
    ...
    intro:
      "سوپرمارکت با هزاران کالا و ده‌ها بدهکار محله، بدون یک سیستم دقیق دچار خطای فروش و ضرر پنهان می‌شود. کمالی حسابداری موبایل‌محور است و کل کار را از روی گوشی انجام می‌دهی.",
    problems: [
  ...
  },
  {
    ...
    intro:
      "در آرایشی بهداشتی و داروخانه، تعدد برند و کد محصول کار را پیچیده می‌کند. کمالی حسابداری هر برند و کد را دقیق کنترل می‌کند و مشتریان دائمی را برای شما نگه می‌دارد.",
    problems: [
  ...
  },
  {
    ...
    intro:
      "فروشگاه موبایل به کنترل دقیق سریال، گارانتی و سود هر مدل نیاز دارد. کمالی حسابداری همه اینها را در یک برنامه موبایل‌محور جمع کرده است.",
    problems: [
  ...
  },
  {
    ...
    intro:
      "در طلافروشی نرخ لحظه‌ای، وزن دقیق و اجرت را باید هر ثانیه حساب کنی. کمالی حسابداری این محاسبات را خودکار می‌کند و امنیت اطلاعات مالی را تضمین می‌کند.",
    problems: [
  ...
  },
  {
    ...
    intro:
      "قنادی و نانوایی به ثبت سفارش کیک، کنترل مواد اولیه و منوی جذاب نیاز دارد. کمالی حسابداری همه این کارها را یکجا انجام می‌دهد.",
    problems: [
  ...
  },
  {
    ...
    intro:
      "فروشگاه ابزار و یراق‌آلات با هزاران قطعه کوچک، بدون بارکد کنترل نمی‌شود. کمالی حسابداری بارکد و موجودی هر قطعه را دقیق نگه می‌دارد.",
    problems: [
  ...
  },
  {
    ...
    intro:
      "کتابفروشی و نوشت‌افزار در فصل مدرسه ترافیک بالایی دارد. کمالی حسابداری با اسکن ISBN و مدیریت دقیق موجودی، مهرماه شلوغ را برایتان راحت می‌کند.",
    problems: [
...
const GENERIC_INTRO =
  "کمالی حسابداری برای همه صنف‌ها طراحی شده — بارکد، انبار، فاکتور، مشتریان و گزارش سود، همه در یک برنامه موبایل ساده.";
              ...
              {showResult && (
                <>
                  ...
                  <div className="mb-2 text-[11px] font-bold text-muted-foreground">
                    کمالی حسابداری برای شما این کارها را می‌کند:
                  </div>
